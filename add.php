...
if(($_SESSION['userid']==1)){
    if ($s) {
		...
		<tr> <td colspan=2> <input type=hidden name=s value=91> <input type=submit name=submit value=submit> </td></tr>
		...
		</form> <br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a> <br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>".$footer;
                break;
            case 91:
            if($newUser and $newPass and $newEmail) {
                addUser($db, $newUser, $newPass, $newEmail);
                echo $header . "Added  new User " . $newUser . "<br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br> <a href=add.php?s=93>Display Users</a> <br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>".$footer;
            }else{
            ...
            case 92:
                $action_fail = "fail";
                if ($stmt = mysqli_prepare($db, "Select user, ip from login where action =?")) {
                    mysqli_stmt_bind_param($stmt, "s", $action_fail);
                    mysqli_stmt_execute($stmt);
                    mysqli_stmt_bind_result($stmt, $postUser, $ip);
                    echo $header . " <u> Login Log</u><br><table>";
                    while (mysqli_stmt_fetch($stmt)) {
                        $ip = htmlspecialchars($ip);
                        $postUser = htmlspecialchars($postUser);
                        echo "<td><tr>$postUser</a></tr></td>
                                <td><tr>  $ip</a></tr></td><br>";
                    }
                }mysqli_stmt_close($stmt);

		        echo "<table> </table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br> <a href=add.php?s=93>Display Users</a> <br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>".$footer;
                break;
            case 93:
                ...
                echo "</table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a> <br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>".$footer;
                break;
            case 94:
                echo $header.'<form><table><tr> <td>Update Password for user '.$postUser.'</td> </tr><br>
                               ...
                               </table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a><br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>'.$footer;

                break;
            case 95:
                echo $header.'<form><table><tr> <td> Add an IP to Whitelist </td> </tr><br>
                                <tr> <td> IP: </td> <td> <input type=text name=ip> </td></tr><br>
                                <tr> <td colspan=2> <input type=submit name=submit value=submit> </td></tr>
                               </table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a><br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>'.$footer;
                break;
            case 99:
        ...
        insertIntoWhitelist($db, $ip);
        echo $header.'<form><table><tr> <td> Added '.$ip.' to Whitelist </td> </tr><br>
                               </table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a><br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>'.$footer;
    }
        ...
        echo $header.'<form><table><tr> <td>Updated Password for user '.$postUser.'</td> </tr><br>
                            </table><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br><a href=add.php?s=93>Display Users</a><br><a href=add.php?s=95>Add IP to Whitelist</a>
                      </form>'.$footer;
        ...
        echo $header . '<form method=post action=add.php> 
                                ...
                                </form><br> <br> <a href=add.php?s=99> Logout </a> <br> <a href=add.php?s=90> Add New Users </a> <br><a href=add.php?s=92> Failed Login Table </a> <br> <a href=add.php?s=95>Add IP to Whitelist</a> </form>'.$footer;
...
}else if (!isset($_SESSION['authenticated']))
{
    if ($postUser and $postPass) {
        if ($stmt = mysqli_prepare($db, "select ip from blacklist")) {
            mysqli_stmt_execute($stmt);
            mysqli_stmt_bind_result($stmt, $ip);
            while (mysqli_stmt_fetch($stmt)) {
                $ip = htmlspecialchars($ip);
                array_push($blacklistIp, $ip);
            }
        }
        if ($stmt = mysqli_prepare($db, "select ip from whitelist")) {
            mysqli_stmt_execute($stmt);
            mysqli_stmt_bind_result($stmt, $ip);
            while (mysqli_stmt_fetch($stmt)) {
                $ip = htmlspecialchars($ip);
                array_push($whitelistIp, $ip);
            }
        }
        authenticate($db, $postUser, $postPass, $whitelistIp, $blacklistIp);
